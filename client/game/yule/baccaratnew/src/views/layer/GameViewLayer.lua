...
local mudule_res = "game/yule/baccaratnew/res/";
--external
--
...
if isDebug() and cc.PLATFORM_OS_WINDOWS == cc.Application:getInstance():getTargetPlatform() then
    cc.FileUtils:getInstance():addSearchPath(mudule_res);
end
