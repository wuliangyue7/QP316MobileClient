...
cocos luacompile -s $Cur_Dir/../client/client -d $Cur_Dir/../ciphercode/client -e -k game766电玩_xxtea_key!!! -b game766电玩_xxtea_sign!!! --disable-compile
if [ $? -eq 1 ]
then
CipherSrcError "lua文件加密出错"
fi

cocos luacompile -s $Cur_Dir/../client/game -d $Cur_Dir/../ciphercode/game -e -k game766电玩_xxtea_key!!! -b game766电玩_xxtea_sign!!! --disable-compile
if [ $? -eq 1 ]
then
CipherSrcError "lua文件加密出错"
fi

cocos luacompile -s $Cur_Dir/../client/base -d $Cur_Dir/../ciphercode/base -e -k game766电玩_xxtea_key!!! -b game766电玩_xxtea_sign!!! --disable-compile
if [ $? -eq 1 ]
then
CipherSrcError "lua文件加密出错"
fi
