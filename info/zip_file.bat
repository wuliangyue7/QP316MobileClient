...
call  cocos luacompile -s ..\client\client -d ..\client\ciphercode\client -e -k game766电玩_xxtea_key!!! -b game766电玩_xxtea_sign!!! --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\game -d ..\client\ciphercode\game -e -k game766电玩_xxtea_key!!! -b game766电玩_xxtea_sign!!! --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\base -d ..\client\ciphercode\base -e -k game766电玩_xxtea_key!!! -b game766电玩_xxtea_sign!!! --disable-compile
if  errorlevel 1 goto CipherSrcError
call  cocos luacompile -s ..\client\command -d ..\client\ciphercode\command -e -k game766电玩_xxtea_key!!! -b game766电玩_xxtea_sign!!! --disable-compile
if  errorlevel 1 goto CipherSrcError
